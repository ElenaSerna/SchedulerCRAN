...
public:
  ...
  static void ResetUeTraces(RadioBearerStatsConnector* c, std::string context, uint64_t imsi);
  static void DisconnectTraces(RadioBearerStatsConnector* c, std::string context, uint64_t imsi, uint16_t cellId, uint16_t rnti);
  ///////////////////////////////////////////////////////////////

private:

  //////////// AÑADIDO PARA SCHEDULER CENTRALIZADO //////////////
  void Reset(std::string context, uint64_t imsi);
  void DisconnectTracesHipercell(std::string context, uint64_t imsi, uint16_t cellId, uint16_t rnti);
  //////////////////////////////////////////////////////////////
