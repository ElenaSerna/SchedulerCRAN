...
private:
  ...
  //////// AÑADIDO PARA SCHEDULER CENTRALIZADO ////////
  bool m_centralizado; // Permite identificar si estamos en un scheduler centralizado o no
  ////////////////////////////////////////////////////
...
public:
  ...
  void SetUe (uint16_t rnti, uint64_t imsi);
  void ConnectTraces(uint64_t imsi, uint16_t rnti);
  void SetUeMap(std::map<uint16_t, Ptr<UeManager>> map);
  std::map<uint16_t, Ptr<UeManager>> GetUeMap();
  std::map<uint16_t, uint64_t> GetIdentifierTable();
  void RemovePrevUe (uint16_t rnti); /// (es igual que el metodo RemoveUe pero publico)
  ///////////////////////////////////////////////
...
public:
  ...
  * RNTI.
  */
  TracedCallback<uint64_t> m_resetUeTraces; // Contiene el vector de ues (imsis) que hay que resetear en la clase radio-bearer-stats-connector
  //////////////////////////////////////////////////////
...
private:
  ...
  ///////// AÑADIDO PARA SCHEDULER CENTRALIZADO /////////
  bool m_connectingTracesFirstTime;
  /////////////////////////////////////////////////////
