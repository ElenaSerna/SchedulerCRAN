              ...
              if (netDev)
                {
                  ...
                  std::cout << "Instante de tiempo en StartTx: " << Simulator::Now() << " Delay programado para StartRx: " << delay << std::endl;
...
{
  NS_LOG_FUNCTION (this);
  std::cout << "Instante de tiempo en StartRx: " << Simulator::Now() << std::endl;
